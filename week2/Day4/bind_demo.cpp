...
int main()
{
    ...
    int b = 20;
    demo(a,std::ref(b));
    auto binded_demo_fn = std::bind(&demo, a, std::reference_wrapper<int>(b));
    ...
    partial_formula_f1(-100, 29, 45);                             //-1 is discarded, 29 is _2 (y) and 45 is _3 (z)
                                                                ///////////////////
    auto partial_formula_f2 = std::bind(formula, 100, _2, _1); // x=100
   ...
   */
  partial_function_swap(20,40,30);

    

    Actor a1;
    
    auto class_func_bind = std::bind(Actor(), _3, _2, _1);
