...
void CreateObjects(std::unordered_map<K,V> & mapData){
    mapData.emplace(101, Employee("Harshit",80903.0f, "Trainer",50));
    mapData.emplace(102, Employee( "Asim", 90903.0f, "Trainee",24));
    mapData.emplace(104, Employee( "Piyush", 90903.0f, "Traine4",24));
    mapData.emplace(103, Employee( "Ayush", 90903.0f, "Trainee",24));
}
 int main(){
