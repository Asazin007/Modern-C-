...
{
    data[0] = std::make_shared<Car>("c101", 80000000, "Dzire", std::make_shared<Engine>(300, 110.4f), CarType::SEDAN);
    data[1] = std::make_shared<Car>("c102", 1000000, "Inova", std::make_shared<Engine>(360, 130.4f), CarType::SUV);
    data[2] = std::make_shared<Car>("c103", 1200000, "Wagaor", std::make_shared<Engine>(280, 100.0f), CarType::HATCHBACK);
}
