...
Car::Car(std::string id, std::string model, EnginePointer engine, CarType c)
    : _id{id}, _model{model}, _engine{engine}, _type{c}
{
}

Car::Car(std::string id, float price, std::string model, EnginePointer engine, CarType c)
